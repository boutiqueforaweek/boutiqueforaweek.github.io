...
* **The Schedule.** Our sale week is shorter! Please review [when you can shop](pages/schedule/event-schedule.md) so you don't miss out! Also of note: there is no early shopping for New Moms, we are not hosting a Mom's Night Out event, and shopping opens to the Public sooner than usual. One fun change- our altered schedule has the bonus of Saturday shopping times.
* **The Stuff.** While you can expect to see much of the same merchandise, we do have changes to some areas (like which clothing and shoe items are allowed to be sold). If you're interested in the specifics, check out our [Items Accepted](pages/consignors/items-accepted.md) and [Items Not Accepted](pages/consignors/items-we-cannot-accept.md) pages.
