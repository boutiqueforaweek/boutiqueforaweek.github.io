...
* [Register](pages/register.md) as a Consignor.
* [Print your tags online](https://www.mysalemanager.net/g_consignorlogin.aspx) with your code and barcode.
* Use white cardstock for unsold items you wish to [donate](pages/consignors/donating-unsold-items.md) and your [assigned color cardstock](pages/consignors/cardstock-color-list.html) for any unsold items you'd like to Pick Up.
* Follow the guidelines for [Pricing](pages/consignors/pricing-recommendations.md) if you have any questions
