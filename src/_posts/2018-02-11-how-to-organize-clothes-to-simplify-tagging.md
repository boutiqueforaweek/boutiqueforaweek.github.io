...
Taking these small steps can make a big difference in the time you spend prepping for the sale. Check out our website for additional tips on [how to prepare your items](src/pages/consignors/preparing-merchandise.md) and videos on [how to tag trickier items](src/pages/consignors/attaching-tags.md).
