...
**Shorter.** The sale [spans only three days](src/pages/schedule/index.md) (but includes Saturday shopping!).
...
If you haven't put the sale on your [calendar](src/pages/schedule/index.md) yet, do it! You won't want to miss it. And if you still need to sign up as a [Volunteer](https://www.mysalemanager.net/wrk_start.aspx?partnercode=BFAW) or [Consignor](src/pages/register.md), don't hesitate. There are less spots and they are filling up fast.
