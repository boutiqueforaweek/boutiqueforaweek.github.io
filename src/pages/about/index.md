...
We aspire to be the premier, upscale kid's consignment sale in Central Florida and the "go to" place for moms. We want you to look forward to the sale as the opportunity to outfit your child(ren) for every need at an affordable price. After all, kids grow much faster than our paychecks.

At Boutique For A Week, we also desire to serve the families in our community, and we would love for all of our consignors to [donate](src/pages/consignors/donating-unsold-items.md) a portion (if not all) of unsold items to those in our community. We invite you to tag on [white cardstock](src/pages/consignors/white-tag-consignors.md) so that your few remaining unsold items will benefit excellent causes! Read about the specific recipients each sale on our [Charities page](src/pages/about/charities.md).

**Thank you for your interest in Boutique For A Week! We invite you to join us as a**

* [Shopper](src/pages/shoppers/index.md)
* [Volunteer](src/pages/volunteers/index.md)
* [Consignor](src/pages/consignors/index.md) or all three!
