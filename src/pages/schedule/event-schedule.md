...
* [White Tag Consignors](src/pages/consignors/white-tag-consignors.md): {{ site.dates.presale_ordinal }}, {{ site.times.white_tag }}
* Consignors: {{ site.dates.presale_ordinal }}, {{ site.times.consignors }}
* [New/Expecting/Adopting/Foster Moms](src/pages/shoppers/first-time-moms.md): {{ site.dates.presale_ordinal }}, {{ site.times.new_moms }}
